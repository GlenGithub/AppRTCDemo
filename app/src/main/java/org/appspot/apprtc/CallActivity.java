...
public class CallActivity extends Activity
    ...
    @Override
    public void onScreenShot() {//Maybe, peerConnectionClient is not necessary
        screenShot();
    }
    ...
    private void screenShot1() {
        ...
        String nombre = "vectormobile";

        try {
            String mPath = Environment.getExternalStorageDirectory().toString() + "/" + now + ".jpg";
            // create bitmap screen capture
//      View v1 = getWindow().getDecorView().getRootView();
            View v1 = localRenderLayout;
     ...
     */
        ...
        Bitmap sb = Bitmap.createBitmap(w, h,
                Bitmap.Config.RGB_565);
        return sb;
    }

    public static void screenShot(int x, int y, int w, int h, String name, GL10 gl) {
